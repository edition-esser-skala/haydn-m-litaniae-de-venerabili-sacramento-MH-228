...
KyrieViolinoII = {
  \relative c' {
    ...
    a8.( g16) g4. g8
    g4( fis8) fis( f) f
    es16-!\ff c( es a) c-! es,( a c) es-! a,( c es)
    ...
    b f' g4 \appoggiatura f8 es4
    d2(\p c8) f'\f %50
    f( d') d4~ d16 b( a c)
    b( f d') d d4~ d16 b( a c)
    b4 f~ f16 as g f
    es( d es f) g-! h,( c d) es-!\p g,( a h)
    d( c d c) d( c es c) b8( a)\trill %55
