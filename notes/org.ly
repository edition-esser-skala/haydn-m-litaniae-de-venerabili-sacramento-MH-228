...
ViaticumOrgano = {
  \relative c {
    ...
    r4 \mvTr es\fE-\tutti h c8 r
    \mvTr f\p-\senzaOrg r b, r es r as r
    d, r g r c, r \mvTr c'4\f-\colOrg
    fis, g8^\critnote r \mvTr c,\p-\senzaOrg r f r
    b, r es r a,! r d r %5
    g, r g' r fis r f r
    e r es r d r d r
    \mvTr cis\f-\colOrg r cis r d r d r
    es! r es r d r d\p r
    cis r cis r d r d r %10
...
ViaticumBassFigures = \figuremode {
  ...
  r
  r
  <1>4 <7 [_!]> <6 4>8 <[5] _+> <1>4
  q4 <6\\> <7+ 6 4>8 <[8 5] _+>4.
  <6 5 _!>2 <_+> %10
  <1>4 q q2 %11 finis
}
...
PignusBassFigures = \figuremode {
  ...
  r2 <[5] 3>4 <6 4-> %65
  <[5] 3>1
  <[6]>2 <5> \bassFigureExtendersOn
  q1
  q4 q \bassFigureExtendersOff r2
  r <6>4 <7! [_!]> %70
  <5! _+>2 <\t \t>
  r <7 5! _+> \bassFigureExtendersOn
  q1
  q
  q4 q \bassFigureExtendersOff r <5! _+> %75
  r \bo <[7 5!] _+>2 \bc <[6 _]>4
  <6! 5>2 <[5!] _+>
  r1
  r
  r %80
  ...
  q %180
  q
  q4 q \bassFigureExtendersOff <6 5> <\t \t [_!]>
  <_+>1
